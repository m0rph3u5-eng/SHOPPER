...
<body class="scrollbar scrollbar-black bordered-black square thin border border-light rounded-lg overflow-auto">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item list-group-item-action">
                <a class="nav-link active" id="top_comm" aria-current="page" href="#"
                  onclick="showcomments()">Directions</a>
              </li>
   ...
   <main>
    ...
    <div class="list2">
      ...
      <div id="comments" class="list-group scrollbar scrollbar-black bordered-black square thin overflow-auto comments"
        style="display: block;">
      ...
      <div id="directions_entry" style="display: none; ">
        <label style="margin-top: 5px; background-color: white;">
          <h2>Directions</h2>
        </label>
        <textarea rows="15" cols="40" class="form-control me-2" name="directions" id="t_directions"></textarea>
      </div>
      <div id="directions" class="list-group scrollbar scrollbar-black bordered-black square thin comments"
        style="display: none; background-color: white;">

        <!-- <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true"> -->

          <div class="d-flex gap-2 w-100 py-3 px-1 justify-content-between">
            <div id="main_list1" style="height: 100%; background-color: white;">
              <h6 id="directions" class="mb-0" style="padding-left:10px ;">Directions</h6>
              <div id="newr" class=" gap-2 w-100 justify-content-between" style="height: 100%; background-color: white; padding: 10px;"></div>
